...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://moonstar.cuteleaf.cn",

	// 站点描述
	description:
		"Moonstar Blog 是我的第一个博客",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo/moonstar-light.png",
			valueDark: "assets/images/logo/moonstar-dark.png",
			alt: "🍀",
		},
		// 导航栏标题
		title: "Moonstar Blog",
