...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			enable: true,
			// 主页横幅主标题
			title: "Hello, Welcome Moonstar's",
			// 主页横幅主标题字体大小
			titleSize: "4.5rem",
			// 主页横幅副标题
			subtitle: [
				"Human beings are a collection of empathy",
				"of Philosophical speculations, of aesthetics",
				"of purposeless love and creativity",
				"The most beautiful dreams are stingy with giving me such imagination",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
